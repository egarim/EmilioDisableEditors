...
namespace EmilioDisableEditors.Blazor.Server {
    public partial class EmilioDisableEditorsBlazorApplication : BlazorApplication {
        public EmilioDisableEditorsBlazorApplication() {
            InitializeComponent();
        }
        ...
        private void EmilioDisableEditorsBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
